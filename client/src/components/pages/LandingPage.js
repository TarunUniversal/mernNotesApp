    ...
    return (
        <>
            ...
            <h1 className='heading' style={{textAlign:'initial'}} >When your heart speaks,<br/>take good notes.</h1>
                <Button className="me-1 btn btn-outline-light" href="/authenticate/login" >Login</Button>
                <Button className="btn btn-outline-dark ms-1" href="/authenticate/register" style={{backgroundColor:'#485785'}} >Register</Button>
